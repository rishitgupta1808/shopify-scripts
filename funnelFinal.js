...
let superAssistantUser2_hostedUrl = "http://localhost:8080";
            ...
            if (funnel.autoPiltoType === "shopifyRecommendation") {
              ...
              <ins style="text-decoration: none; color: ${modalStyle.newPriceColor}; font-weight: 600">
                ...
                >Free shipping included</span>`;
                        ...
                        let imageUrl = "";
                        if(recommendedProductsList[i].variants[0].featured_image===null){
                          imageUrl = `https://${recommendedProductsList[
                            i
                          ].featured_image.slice(2)}`;
                        } else {
                          imageUrl = recommendedProductsList[i].variants[0].featured_image.src
                        }
              ...
              for (let i = 0; i < recommendedProductsList.length; i++) {
                if(true) 
                  ...
                  originalPrice = recommendedProductsList[i].variants[0].price/100;
              ...
              <ins style="text-decoration: none; color: ${modalStyle.newPriceColor}; font-weight: 600">
                ...
                >Free shipping included</span>`;
                  ...
                  // }
                  let imageUrl = "https://cdn.jsdelivr.net/gh/varuns1007/Hosted-Links/sale.jpg";
                    ...
                    .then((data) => {
                      ...
                      if (
                        ...
                        if (funnel.funnelRules.set_start_date.isSelected) {
                          startDate =
                            funnel.funnelRules.set_start_date.startDate;
                        }
                        ...
                        if (
                          ...
                          for (let i = 0; i < offeredProductIds.length; i++) {
                            ...
                            for (let j = 0; j < cart.items.length; j++) {
                              if (
                                cart.items[j].product_id === offeredProductId
                              ) {
                        ...
                        if (funnel.funnelRules.specific_countries.isSelected) {
                          let selectedCountries_arr =
                            funnel.funnelRules.specific_countries
                              .selectedCountries;
                        ...
                        if (funnel.funnelRules.once_per_buyer) {
                          let storedValue =
                            localStorage.getItem("oncePerBuyer");
                          if (storedValue === null) {
                    ...
                    startTimer(fiveMinutes, timer);
                          ...
                          async function addViews() {
                            let addViews = await fetch(
                              `${superAssistantUser2_hostedUrl}/api/analytics/addViews`,
                              {
                                method: "POST",
                                // mode: "no-cors",
                                headers: {
            ...
            if (funnel.autoPiltoType === "shopifyRecommendation") {
              ...
              for (let i = 0; i < recommendedProductsList.length; i++) {
                  ...
                  // (recommendedProductsList[i].available) since we dont have available in cart items too
                {
                  ...
                  originalPrice =
                    recommendedProductsList[i].price / 100;
...
>
 ...
 function createSlide(obj,type) {
  ...
  `;
      ...
      if (type === 'manual') {
        document.querySelector(`#openUpSellParent_Button-${obj.INDEX}`).onclick = () => {
          let quantity = parseFloat(
        ...
        if (funnel.autoPiltoType === "shopifyRecommendation") {
          ...
          for (let i = 0; i < recommendedProductsList.length; i++) {
              ...
              // (recommendedProductsList[i].available) since we dont know the availability of a product in thanku page
            {
              ...
              originalPrice =
                recommendedProductsList[i].price;
